...
exports.update = async (req, res) => {
  ...
  const {
    ...
    duid,
    buildingId,
    sundayStartAccessTime,
    sundayEndAccessTime,
    mondayStartAccessTime,
    mondayEndAccessTime,
    tuesdayStartAccessTime,
    tuesdayEndAccessTime,
    wednesdayStartAccessTime,
    wednesdayEndAccessTime,
    thursdayStartAccessTime,
    thursdayEndAccessTime,
    fridayStartAccessTime,
    fridayEndAccessTime,
    saturdayStartAccessTime,
    saturdayEndAccessTime,
  } = req.body;
  ...
  try {
    const updatedRoom = await prisma.room.update({
      ...
      data: {
        ...
        buildingId,
        sundayStartAccessTime: parseInt(sundayStartAccessTime),
        sundayEndAccessTime: parseInt(sundayEndAccessTime),
        mondayStartAccessTime: parseInt(mondayStartAccessTime),
        mondayEndAccessTime: parseInt(mondayEndAccessTime),
        tuesdayStartAccessTime: parseInt(tuesdayStartAccessTime),
        tuesdayEndAccessTime: parseInt(tuesdayEndAccessTime),
        wednesdayStartAccessTime: parseInt(wednesdayStartAccessTime),
        wednesdayEndAccessTime: parseInt(wednesdayEndAccessTime),
        thursdayStartAccessTime: parseInt(thursdayStartAccessTime),
        thursdayEndAccessTime: parseInt(thursdayEndAccessTime),
        fridayStartAccessTime: parseInt(fridayStartAccessTime),
        fridayEndAccessTime: parseInt(fridayEndAccessTime),
        saturdayStartAccessTime: parseInt(saturdayStartAccessTime),
        saturdayEndAccessTime: parseInt(saturdayEndAccessTime),
      },
    });
...
exports.delete = async (req, res) => {
  ...
  try {
    ...
    if (deletedRoom.device.deviceType === "MULTI_NETWORK") {
      ...
      let gatewayShortId =
        deletedRoom?.device?.Gateway_Spot?.gatewayDevice?.gateway_short_id;
      if (!gatewayShortId) {
    ...
    const updatedRoom = await prisma.room.update({
      ...
      select: {
        card: {
          where: {
            card_number: {
              in: [...requestForRoom.map((data) => data.card.card_number)],
            },
          },
          select: {
            card_number: true,
